...
import { getAssetCache, type CacheEntry } from '@/lib/services/AssetCache';
import { getAssetOptimizer, type AssetOptimizationOptions } from '@/lib/utils/AssetOptimization';
