...
export const Empty: React.FC<EmptyProps> = ({
  ...
  return (
    <div
      role="status"
      aria-label={message}
      className={`flex flex-col items-center justify-center py-12 px-4 text-center border border-dashed border-neutral-800 bg-black/10 ${className}`}
    >
      <div className="text-neutral-700 mb-4" aria-hidden="true">
        {icon || (
