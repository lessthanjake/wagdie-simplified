...
export const Layout: React.FC<LayoutProps> = ({ children }) => {
  return (
    <div className="min-h-screen flex flex-col items-center bg-soul-950 text-neutral-300 font-body selection:bg-soul-blood selection:text-white overflow-x-hidden">
      {/* Top Vignette */}
