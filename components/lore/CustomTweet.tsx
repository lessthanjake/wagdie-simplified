    ...
    <Card className={`overflow-hidden transition-all duration-500 hover:border-soul-accent/40 ${className}`}>
      ...
      <div className="p-4 border-b border-neutral-800/50">
        <div className="flex items-center gap-3">
          ...
          />
          <div>
            <p className="font-display  tracking-normal text-sm text-neutral-200">
              @{tweet.author_username}
            </p>
            <p className="text-xs text-neutral-600 font-body">{formatDate(tweet.created_at)}</p>
          </div>
        </div>
      </div>
      ...
      <CardContent className="p-4">
        <p className="text-neutral-300 font-body leading-relaxed whitespace-pre-wrap mb-4">
          {tweet.text}
        </p>
        ...
        {translationEnabled && (
          <div className="bg-black/30 border border-neutral-800 p-3 mb-4">
            <p className="text-sm text-neutral-600 font-body italic">
